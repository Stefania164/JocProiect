...
public class AnemoBall extends Component {
    public transient boolean goingRight = false;
    private transient Rigidbody2D rb;
    private transient float anemoBallSpeed = 1.7f;
    ...
    private static int anemoBall = 0;
    ...
    public void preSolve(GameObject obj, Contact contact, Vector2f contactNormal) {
        if (obj.getComponent(PlayerController.class) != null ||
                obj.getComponent(AnemoBall.class) != null) {
